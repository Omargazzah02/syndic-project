...
from .views import ChargesListView,AddChargeView , ChargesManagingListView , DeleteChargeView , UpdateChargeView , PredictChargesView
...
urlpatterns = [
    ...
    path('predict_charges/', PredictChargesView.as_view(), name='predict-charges'),
